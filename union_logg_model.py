...
class Log_Bert(nn.Module):
    ...
    def forward(self, x,y, batch_size,user_list,item_list):
        ...
        out = self.linear7(out).unsqueeze(1) #最后一层线性层不宜多加
...
class Log_Bert(nn.Module):
    ...
    def __init__(self,u_max,):
        ...
        self.conv3 = nn.Sequential(
            nn.Conv1d(in_channels=768, out_channels=768, kernel_size=(5), #dilation=3
                      ),nn.MaxPool1d(kernel_size=(u_max//2)+3))
...
if __name__ == '__main__':
    ...
    data_list =['reviews_Automotive_5']
    #"Clothing_Shoes_and_Jewelry_5","Office_Products_5","Patio_Lawn_and_Garden_5"]
    '''
    ...
    ["Health_and_Personal_Care_5",'Clothing_Shoes_and_Jewelry_5','Books_5']
        ["Clothing_Shoes_and_Jewelry_5",'Electronics_5',"Video_Games_5",'Instant_Video_5','Automotive_5',
